import { TJsAppConfigInput, TJsTrackProperties } from "@typeflowai/types/js";
...
export type TTypeflowAIApp = typeof typeflowai;
export default typeflowai as TTypeflowAIApp;
