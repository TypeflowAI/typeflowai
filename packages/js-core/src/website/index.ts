import { TJsTrackProperties, TJsWebsiteConfigInput } from "@typeflowai/types/js";
...
export type TTypeflowAIWebsite = typeof typeflowai;
export default typeflowai as TTypeflowAIWebsite;
