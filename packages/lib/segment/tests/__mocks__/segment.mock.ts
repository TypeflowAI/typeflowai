...
export const mockWorkflowId = "phz5mjwvatwc0dqwuip90qpv";
...
export const mockSegmentPrisma = {
  ...
  createdAt: new Date(),
  updatedAt: new Date(),
  workflows: [{ id: mockWorkflowId }],
};

export const mockSegmentActiveInactiveSurves = {
  activeWorkflows: ["Churn Workflow"],
  inactiveWorkflows: ["NPS Workflow"],
};
