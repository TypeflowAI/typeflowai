...
import type { TProduct, TProductUpdateInput } from "@typeflowai/types/product";
import { ZProduct, ZProductUpdateInput } from "@typeflowai/types/product";
