...
export const env = createEnv({
  ...
  server: {
    ...
    TYPEFLOWAI_ENCRYPTION_KEY: z.string().length(24).or(z.string().length(0)).optional(),
    ...
    IS_TYPEFLOWAI_CLOUD: z.enum(["1", "0"]).optional(),
   ...
   */
  client: {
    NEXT_PUBLIC_TYPEFLOWAI_API_HOST: z
      .string()
      .url()
      .optional()
      .or(z.string().refine((str) => str === "")),
    NEXT_PUBLIC_TYPEFLOWAI_ENVIRONMENT_ID: z.string().optional(),
    NEXT_PUBLIC_TYPEFLOWAI_ONBOARDING_WORKFLOW_ID: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    TYPEFLOWAI_ENCRYPTION_KEY: process.env.TYPEFLOWAI_ENCRYPTION_KEY,
    ...
    IS_TYPEFLOWAI_CLOUD: process.env.IS_TYPEFLOWAI_CLOUD,
    MAIL_FROM: process.env.MAIL_FROM,
    NEXTAUTH_SECRET: process.env.NEXTAUTH_SECRET,
    NEXTAUTH_URL: process.env.NEXTAUTH_URL,
    NEXT_PUBLIC_TYPEFLOWAI_API_HOST: process.env.NEXT_PUBLIC_TYPEFLOWAI_API_HOST,
    NEXT_PUBLIC_TYPEFLOWAI_ENVIRONMENT_ID: process.env.NEXT_PUBLIC_TYPEFLOWAI_ENVIRONMENT_ID,
    NEXT_PUBLIC_TYPEFLOWAI_ONBOARDING_WORKFLOW_ID: process.env.NEXT_PUBLIC_TYPEFLOWAI_ONBOARDING_WORKFLOW_ID,
