        ...
        <div>
          ...
          <div className="mt-4">
            <fieldset>
              ...
              <div className="bg-workflow-bg relative space-y-2" ref={choicesContainerRef}>
                  ...
                  <label
                    ...
                    {otherSelected && (
                      <input
                        ...
                        className="placeholder:text-placeholder border-border bg-workflow-bg text-heading focus:ring-focus rounded-custom mt-3 flex h-10 w-full border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        placeholder={
