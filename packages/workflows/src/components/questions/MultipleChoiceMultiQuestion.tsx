...
import type { TWorkflowMultipleChoiceMultiQuestion } from "@typeflowai/types/workflows";
    ...
    <form
      ...
      <div className="mt-4">
        <fieldset>
          ...
          <div className="bg-workflow-bg relative max-h-[42vh] space-y-2 overflow-y-auto rounded-md py-0.5 pr-2">
              ...
              <label
                ...
                {otherSelected && (
                  <input
                    ...
                    className="placeholder:text-placeholder border-border bg-workflow-bg text-heading focus:ring-focus mt-3 flex h-10 w-full rounded-md border px-3 py-2 text-sm  focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
