...
import { getMonthName, getOrdinalDate } from "@typeflowai/lib/utils/datetime";
          ...
          <div
            ...
            <div className="relative">
              ...
              <DatePicker
                ...
                className={`dp-input-root rounded-custom wrapper-hide ${
                  !datePickerOpen ? "" : "h-[46dvh] sm:h-[34dvh]"
                }
