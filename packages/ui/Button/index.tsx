...
export type ButtonBaseProps = {
  variant?: "highlight" | "primary" | "secondary" | "minimal" | "warn" | "alert" | "darkCTA" | "lightCTA";
  size?: "base" | "sm" | "lg" | "xl" | "fab" | "icon";
  loading?: boolean;
  disabled?: boolean;
  ...
  const element: any = React.createElement(
    elementType,
    {
      ...
      className: cn(
        ...
        size === "xl" && "px-4 py-4 text-base font-medium rounded-md",
        size === "icon" &&
        ...
        variant === "primary" &&
          (disabled
            ? "border border-transparent bg-slate-400 text-white"
            : "text-white bg-brand hover:bg-brand focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-slate-900"),

        variant === "minimal" &&
          (disabled
            ? "border border-slate-200 text-slate-400"
            : "hover:text-slate-600 text-slate-700  focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-neutral-900"),
        variant === "alert" &&
          (disabled
            ? "border border-transparent bg-slate-400 text-white"
            : "border border-transparent text-brandcontrast bg-red-600 hover:bg-opacity-90 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-neutral-900"),
        variant === "secondary" &&
          (disabled
            ? "text-slate-400 bg-slate-200"
            : "text-slate-600 hover:text-slate-500 bg-slate-200 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-offset-1  focus:bg-slate-300 focus:ring-neutral-500"),
        variant === "warn" &&
          (disabled
        ...
        variant === "darkCTA" &&
          (disabled
            ? "text-slate-400 bg-slate-200"
            : "text-slate-100 hover:text-slate-50 bg-violet-950 focus:outline-none focus:ring-2 focus:ring-offset-1  focus:bg-violet-950 focus:ring-neutral-500"),
        variant === "lightCTA" &&
          (disabled
            ? "border border-transparent bg-slate-400 text-violet-950"
            : "text-violet-950 hover:text-violet-950 bg-lime-300 focus:outline-none focus:ring-2 focus:ring-offset-1  focus:bg-violet-950 focus:ring-neutral-500"),
