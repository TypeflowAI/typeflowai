...
export const EventIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 64 64">
    ...
    <path
      fill="#fff"
      d="M19.1 28.4v.2c0 .8.1 1.4.3 1.7c.1.3.5.5 1 .5s.8-.2 1-.5c.1-.2.1-.6.1-1.1V22h2.2v7.1c0 .9-.2 1.6-.5 2.1c-.5.9-1.4 1.3-2.8 1.3s-2.2-.3-2.7-1s-.7-1.6-.7-2.9v-.2zm6.9-6.3h2.2v6.3c0 .7.1 1.2.3 1.5c.3.6.8.9 1.7.9c.9 0 1.5-.3 1.7-.9c.2-.3.3-.8.3-1.5v-6.3h2.2v6.3c0 1.1-.2 1.9-.5 2.5c-.7 1.1-1.9 1.7-3.7 1.7s-3.1-.6-3.7-1.7c-.3-.6-.5-1.5-.5-2.5zm10.6 0h2.2v8.4h5.3v1.8h-7.5z"
    />
    <path
      fill="#333"
      d="M16.1 44.5v-2.8c1.3-.1 2.1-.1 2.6-.3c.8-.2 1.4-.5 1.9-1.1c.3-.4.6-.9.8-1.5c.1-.4.2-.6.2-.8h3.3v20.6h-4.1V44.5zm28.9-3c-.6.6-1.4 1.7-2.5 3.2c-1.1 1.5-2 3.1-2.7 4.7c-.6 1.3-1.1 2.8-1.5 4.7c-.5 1.8-.7 3.4-.7 4.6h-4.1c.1-3.7 1.3-7.5 3.6-11.5c1.5-2.5 2.7-4.2 3.7-5.2H30.7l.1-3.6H45z"
    />
  </svg>
);
