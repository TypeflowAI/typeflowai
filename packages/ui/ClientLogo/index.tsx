...
export const ClientLogo = ({ environmentId, product, previewWorkflow = false }: ClientLogoProps) => {
  return (
    <div
      className={cn(
        previewWorkflow ? "" : "left-3 top-3 md:left-7 md:top-7",
        "group absolute z-0 rounded-lg"
      )}
      ...
      {product.logo?.url ? (
        <Image
          ...
          className={cn(
            previewWorkflow ? "max-h-12" : "max-h-16 md:max-h-20",
