...
export const GoogleAdsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="1.12em" height="1em" viewBox="0 0 256 256">
    <path
      fill="#FBBC04"
