...
export const PitchIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48">
    <path fill="#45413c" d="M6.75 38.16a11.5 1.5 0 1 0 23 0a11.5 1.5 0 1 0-23 0" opacity="0.15" />
    <path
      fill="#ffe500"
      stroke="#45413c"
    ...
    <path
      fill="#adc4d9"
      d="M16.82 12.26c6.08-1 10.09 1.25 11.85-.29A6.75 6.75 0 0 0 29 8.34c-1.56 2.19-5.69-.43-12.16.63a10.73 10.73 0 0 0-9.34 9.31a11.09 11.09 0 0 0 0 2.94a10.73 10.73 0 0 1 9.32-8.96m11.02 5.21v-.92c-.76 2.24-.33 5.29.78 6.44l.55.57l.93-.67a1 1 0 0 0 .13-1.51l-1.61-1.67a2.92 2.92 0 0 1-.78-2.24"
    />
    <path
      fill="none"
      stroke="#45413c"
