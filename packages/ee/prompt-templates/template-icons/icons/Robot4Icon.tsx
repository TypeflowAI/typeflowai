...
export const Robot4Icon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 128 128">
    <path
      fill="#e06055"
      d="M86.05 35.16H41.64V21.19c0-6.51 5.27-11.78 11.78-11.78h20.85c6.51 0 11.78 5.27 11.78 11.78z"
    />
    <path
      fill="#fff"
      d="M55.12 11.62c-.64-1.89-4.14-.77-5.95.32s-4.34 3.97-3.43 4.7c.9.72 2.38-1.12 5.53-1.99c2.93-.81 4.38-1.47 3.85-3.03"
    />
    <path
      fill="#ce453e"
    ...
    <path
      fill="#78a3ad"
      d="m119.73 58.05l2.06-45.88a2.612 2.612 0 0 1 5.22.12v58.98c0 .83-.4 1.62-1.07 2.11l-7.41 5.41zm-111.46 0L6.22 12.17a2.622 2.622 0 0 0-2.61-2.49C2.17 9.68 1 10.85 1 12.29v58.98c0 .83.4 1.62 1.07 2.11l7.41 5.41z"
    />
    <ellipse cx="13.69" cy="66.89" fill="#e06055" rx="9.33" ry="17.34" />
    <defs>
      <ellipse id="notoV1Robot0" cx="13.69" cy="66.89" rx="9.33" ry="17.34" />
    </defs>
    ...
    <clipPath id="notoV1Robot3">
      <use href="#notoV1Robot2" />
    </clipPath>
    <path
      fill="#ce453e"
    ...
    <defs>
      <ellipse id="notoV1Robot4" cx="114.38" cy="66.89" rx="9.33" ry="17.34" />
    </defs>
    <clipPath id="notoV1Robot5">
      <use href="#notoV1Robot4" />
    </clipPath>
    <path
      fill="#ce453e"
    ...
    />
    <defs>
      <ellipse id="notoV1Robot6" cx="114.38" cy="66.89" rx="9.33" ry="17.34" />
    </defs>
    ...
    <path
      fill="#64878e"
      d="M8.04 52.98S3.08 64.56 5.86 76.14l-3.49-2.55s.28-5.78 1.99-12.15c1.72-6.39 3.68-8.46 3.68-8.46m111.92 0s4.96 11.58 2.18 23.16l3.49-2.55s-.28-5.78-1.99-12.15c-1.72-6.39-3.68-8.46-3.68-8.46"
    />
    <path
      fill="#e06055"
      d="m61.85 65.7l-5.39 12.95c-.56 1.34.43 2.82 1.88 2.82h10.57c1.44 0 2.43-1.46 1.89-2.79l-5.18-12.95c-.68-1.69-3.07-1.71-3.77-.03"
    />
    <path
      fill="#eda29b"
      d="M63.46 67.6c-1.09-.31-1.42 1.41-2 2.92c-.96 2.53-1.22 3.71-.69 3.9c.7.26 1.31-.54 2.25-2.83c.9-2.15 1.36-3.73.44-3.99"
    />
    <path fill="#eceff1" d="M48.39 90.33v10.21m10.58-10.21v10.21m10.59-10.21v10.21m10.58-10.21v10.21" />
    <path
      fill="#b8e9f4"
      d="M81.99 100.54H46.21c-4.91 0-8.9-3.98-8.9-8.9v-1.31h53.57v1.31c0 4.91-3.98 8.9-8.89 8.9"
    />
    <path
      fill="#546e7a"
      stroke="#546e7a"
    ...
    <path
      fill="#b8e9f4"
      d="M50.71 92.47h6.2v5.96h-6.2zm9.81 0h6.2v5.96h-6.2zm9.81 0h6.2v5.96h-6.2zm10.05 5.96h-.24v-5.96h6.2c0 3.29-2.67 5.96-5.96 5.96m-33.27 0h-.24c-3.29 0-5.96-2.67-5.96-5.96h6.2z"
    />
    <path
      fill="#fff"
    ...
    <path
      fill="#7cb342"
      d="M108 194.76c-4.14-.01-7.5 3.35-7.5 7.49l-.04 31.39c0 4.15 3.35 7.5 7.49 7.51c4.14 0 7.5-3.34 7.5-7.49l.03-31.39c.01-4.15-3.34-7.51-7.48-7.51m-87.95-.12c-4.14-.01-7.5 3.35-7.51 7.49l-.04 31.39c-.01 4.15 3.35 7.5 7.49 7.51c4.14.01 7.5-3.34 7.5-7.49l.05-31.4c.01-4.13-3.35-7.49-7.49-7.5m77.79-1.23c-.04-11.53-6.95-21.56-17.17-26.87l5.24-9.55c.28-.5.1-1.14-.41-1.42c-.51-.27-1.14-.09-1.41.41l-5.3 9.65c-4.45-1.98-9.42-3.1-14.69-3.1c-5.25-.01-10.23 1.09-14.66 3.05l-5.28-9.64a1.04 1.04 0 0 0-1.41-.42c-.51.27-.7.91-.41 1.41l5.22 9.56c-10.25 5.27-17.2 15.3-17.26 26.84v.14l67.53.08c.01-.05.01-.1.01-.14m-49.12-12.15a2.832 2.832 0 0 1-2.82-2.83c0-1.56 1.27-2.83 2.83-2.83c1.57 0 2.83 1.28 2.83 2.84c0 1.55-1.27 2.82-2.84 2.82m30.75.03c-1.56 0-2.83-1.27-2.83-2.83a2.849 2.849 0 0 1 2.84-2.83c1.55.01 2.82 1.29 2.82 2.84c0 1.56-1.27 2.82-2.83 2.82m18.14 14.86l-67.02-.08l-.05 43.17h-.01v5.49c-.01 4.43 3.56 8 7.99 8.01l5.44.01l-.01 6.51h.01l-.01 10.1c-.01 4.13 3.35 7.5 7.48 7.51c4.14.01 7.5-3.36 7.51-7.49l.02-16.61l10.12.01l-.02 16.61c-.01 4.13 3.35 7.51 7.48 7.5c4.14.01 7.5-3.35 7.51-7.49l.01-10.09h.02l.01-6.51h5.44c.83 0 1.63-.12 2.38-.36c3.26-1.01 5.63-4.04 5.63-7.63l.02-5.47h-.01z"
    />
    <path
      fill="#fff"
      d="M48.73 175.59c-1.56 0-2.83 1.27-2.83 2.83s1.26 2.83 2.82 2.83c1.57 0 2.84-1.27 2.84-2.83a2.84 2.84 0 0 0-2.83-2.83m30.75.03c-1.56 0-2.83 1.28-2.84 2.83c0 1.57 1.27 2.83 2.83 2.83s2.83-1.26 2.83-2.83c0-1.54-1.27-2.82-2.82-2.83"
    />
  </svg>
);
