            ...
            questions: [
              {
                ...
                headline: "How disappointed would you be if you could no longer use Test-TypeflowAI?",
                required: true,
              ...
              },
              {
                id: questionTwoId,
                type: "openText",
                headline: "How can we improve Test-TypeflowAI for you?",
                required: true,
...
export const mockEventTrackResponse = () => {
  ...
  console.log('TypeflowAI: Event "Button Clicked" tracked');
};
