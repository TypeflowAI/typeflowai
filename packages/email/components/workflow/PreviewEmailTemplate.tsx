...
export const getPreviewEmailTemplateHtml = (
  ...
  return render(<PreviewEmailTemplate workflow={workflow} workflowUrl={workflowUrl} styling={styling} />, {
    pretty: true,
  });
};

export const PreviewEmailTemplate = ({ workflow, workflowUrl, styling }: PreviewEmailTemplateProps) => {
  ...
  switch (firstQuestion.type) {
    case TWorkflowQuestionType.OpenText:
      return (
        <EmailTemplateWrapper workflowUrl={url} styling={styling}>
...
const EmailFooter = () => {
  return (
    <Container className="m-auto mt-8 text-center">
      <Link href="https://typeflowai.com/" target="_blank" className="text-signature-color text-xs">
