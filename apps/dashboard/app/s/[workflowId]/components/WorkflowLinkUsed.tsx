...
import { TWorkflowSingleUse } from "@typeflowai/types/workflows";

import footerLogo from "../lib/footerlogo.svg";

type WorkflowLinkUsedProps = {
  singleUseMessage: TWorkflowSingleUse | null;
};

const WorkflowLinkUsed = ({ singleUseMessage }: WorkflowLinkUsedProps) => {
  const defaultHeading = "The workflow has already been answered.";
...
export default WorkflowLinkUsed;
