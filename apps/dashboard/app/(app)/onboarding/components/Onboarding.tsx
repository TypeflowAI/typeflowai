  ...
  return (
    <div className="flex h-full w-full flex-col bg-slate-50">
      ...
      <div className="flex grow items-center justify-center">
        {currentStep === 1 && <Greeting next={next} skip={doLater} name={user.name ? user.name : ""} />}
        {currentStep === 2 && (
          <Role
            next={next}
            skip={skipStep}
        ...
        {currentStep === 3 && (
          <Objective next={next} skip={skipStep} typeflowaiResponseId={typeflowaiResponseId} user={user} />
        )}
        {currentStep === 4 && (
