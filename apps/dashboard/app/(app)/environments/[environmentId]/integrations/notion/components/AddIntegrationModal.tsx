...
export default function AddIntegrationModal({
  ...
  useEffect(() => {
    ...
    resetForm();
  }, [selectedIntegration, workflows, databases]);
        ...
        <div className="flex w-full items-center gap-3">
          <div className="flex w-full items-center">
            <div className="w-[340px] max-w-full">
              <DropdownSelector
                placeholder="Select a workflow question"
          ...
          <div className="flex justify-between rounded-lg p-6">
            <div className="w-full space-y-4">
              <div>
                ...
                {selectedDatabase && selectedWorkflow && (
                  <div>
                    <Label>Map TypeflowAI fields to Notion property</Label>
                    <div className="mt-4">
                      {mapping.map((_, idx) => (
