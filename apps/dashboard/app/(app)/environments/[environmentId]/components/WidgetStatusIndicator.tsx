...
export default async function WidgetStatusIndicator({ environmentId, type }: WidgetStatusIndicatorProps) {
  ...
  const stati = {
    notImplemented: {
      icon: ArrowDownIcon,
      color: "slate",
      title: "Connect TypeflowAI to your app.",
      subtitle: "You have not yet connected TypeflowAI to your app. Follow setup guide.",
    },
    running: {
      icon: CheckIcon,
      color: "green",
      title: "Receiving data.",
      subtitle: "You have successfully connected TypeflowAI to your app.",
    },
  };
