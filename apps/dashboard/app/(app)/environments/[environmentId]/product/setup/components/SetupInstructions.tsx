      ...
      <div className="px-6 py-5">
        {activeTab === "npm" ? (
          <div className="prose prose-slate">
            ...
            <CodeBlock language="sh">npm install @typeflowai/js</CodeBlock>
            <p>or</p>
            <CodeBlock language="sh">yarn add @typeflowai/js</CodeBlock>
            ...
            <CodeBlock language="js">{`import typeflowAI from "@typeflowai/js/website";
            ...
            <ul className="list-disc text-slate-700">
              ...
              <li>
                ...
                <Link
                  ...
                  href="https://typeflowai.com/docs/website-workflows/quickstart"
                  target="_blank">
                  Check out the docs.
                </Link>
              </li>
