...
import { TWorkflow, TWorkflowQuestionSummary } from "@typeflowai/types/workflows";
      ...
      <div className={"align-center flex justify-between gap-4 "}>
        <h3 className="pb-1 text-lg font-semibold text-slate-900 md:text-xl">
          {formatTextWithSlashes(
            recallToHeadline(questionSummary.question.headline, workflow, true, "default", attributeClasses)[
              "default"
            ]
          )}
        </h3>
