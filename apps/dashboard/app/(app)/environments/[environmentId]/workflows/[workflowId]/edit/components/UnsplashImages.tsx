...
import { TWorkflowBackgroundBgType } from "@typeflowai/types/workflows";
...
interface ImageFromUnsplashWorkflowBgProps {
  handleBgChange: (url: string, bgType: TWorkflowBackgroundBgType) => void;
}
...
export const ImageFromUnsplashWorkflowBg = ({ handleBgChange }: ImageFromUnsplashWorkflowBgProps) => {
