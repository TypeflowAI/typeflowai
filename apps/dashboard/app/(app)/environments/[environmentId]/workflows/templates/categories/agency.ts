    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "product-service",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the product/service on the invoice?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "company",
          type: TWorkflowQuestionType.OpenText,
          headline: "What company is billed on the invoice?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "number-days",
          type: TWorkflowQuestionType.OpenText,
          headline: "Number of days since the payment was due",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "client-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's your client name?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "product-service",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's your product/service about?",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "project",
          type: TWorkflowQuestionType.OpenText,
          headline: "What project has been done?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "details",
          type: TWorkflowQuestionType.OpenText,
          headline: "Write some details to add to the email",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "data",
          type: TWorkflowQuestionType.OpenText,
          headline: "Relevant data/statistics that show your impact",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "project-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the project name?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "data-points",
          type: TWorkflowQuestionType.OpenText,
          headline: "Describe data points to include on the report",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "issue",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is the complaint about?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "project-type",
          type: TWorkflowQuestionType.OpenText,
          headline: "Describe the type of project",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "area",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the area of expertise?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "project-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is the project name",
          subheader: "",
          required: true,
          inputType: "text",
        },
        ...
        },
        {
          id: "area",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the area of the project?",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "period",
          type: TWorkflowQuestionType.OpenText,
          headline: "Period of time over the past",
          subheader: "E.g. Month, Day...",
          required: true,
          inputType: "text",
        },
      ],
      ...
      questions: [
        {
          id: "company",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's your company about?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "report-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the name of the report?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          ...
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the expense item?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "policies-guidelines",
          type: TWorkflowQuestionType.OpenText,
          headline: "Paste here you policies & guidelines",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "customer-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the customer name?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "product-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the product name?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        ...
        },
        {
          id: "reason",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the reason for the refund?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "client-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the client name?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "timeframe",
          type: TWorkflowQuestionType.OpenText,
          headline: "Timeframe for the payment schedule",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "number",
          type: TWorkflowQuestionType.OpenText,
          headline: "Number of installments",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "amount",
          type: TWorkflowQuestionType.OpenText,
          headline: "Amount of each installment",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "revenue",
          type: TWorkflowQuestionType.OpenText,
          headline: "Revenue by product/service category",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "period",
          type: TWorkflowQuestionType.OpenText,
          headline: "Period for this revenue",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "campaign-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the campaign name?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "date",
          type: TWorkflowQuestionType.OpenText,
          headline: "What date are you launching the campaign?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "goals",
          type: TWorkflowQuestionType.OpenText,
          headline: "What are the goals for the campaign?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "industry",
          type: TWorkflowQuestionType.OpenText,
          headline: "What industry do you want to research?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "product-service",
          type: TWorkflowQuestionType.OpenText,
          headline: "What type of product/service do you want to research?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "location",
          type: TWorkflowQuestionType.OpenText,
          headline: "What country/region would you like to research?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "industry",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's industry of your business?",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "features",
          type: TWorkflowQuestionType.OpenText,
          headline: "Describe features/benefits of the product",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "current-sale",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the current sale?",
          subheader: "E.g. Operating nationally, planning to expand internationally",
          required: true,
          inputType: "text",
        },
        {
          id: "key-challenges",
          type: TWorkflowQuestionType.OpenText,
          headline: "What are your key challenges?",
          subheader: "E.g. Generating new Customers",
          required: true,
          inputType: "text",
        },
      ],
      ...
      questions: [
        {
          id: "product-service",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is your service/product about?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "target-audience",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is the target audience of your business",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "topic",
          type: TWorkflowQuestionType.OpenText,
          headline: "What topic do you want to cover in the lead magnet?",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "agency-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the agency name?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "results",
          type: TWorkflowQuestionType.OpenText,
          headline: "Describe the results of the case study",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "key-metrics",
          type: TWorkflowQuestionType.OpenText,
          headline: "Name some key metrics",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "topics",
          type: TWorkflowQuestionType.OpenText,
          headline: "Name and describe some topics for the meeting",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "deadline",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the deadline of the project?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "task",
          type: TWorkflowQuestionType.OpenText,
          headline: "What task has to be done?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "skill-experience",
          type: TWorkflowQuestionType.OpenText,
          headline: "What skill/experience is necessary for the task?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "deadline",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the deadline of the task?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "project-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the name of the project?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "goals",
          type: TWorkflowQuestionType.OpenText,
          headline: "What are the goals of the project?",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "objectives",
          type: TWorkflowQuestionType.OpenText,
          headline: "What are the objective of the project?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "project",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is your project about?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "project",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is your task/project about?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "data",
          type: TWorkflowQuestionType.OpenText,
          headline: "Provide some information to take into account",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "expenses",
          type: TWorkflowQuestionType.OpenText,
          headline: "Provide information about the project expenses",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "timeframe",
          type: TWorkflowQuestionType.OpenText,
          headline: "What time frame would you like to analize?",
          subheader: "E.g. Month, Quarter...",
          required: true,
          inputType: "text",
        },
      ],
      ...
      questions: [
        {
          ...
          type: TWorkflowQuestionType.OpenText,
          headline: "What are your project assumptions?",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "data",
          type: TWorkflowQuestionType.OpenText,
          headline: "Provide data to ensure the project stays on track",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "schedule",
          type: TWorkflowQuestionType.OpenText,
          headline: "Provide information about the current schedule",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "team-size",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the time size?",
          subheader: "E.g. 20 members, cross-functional",
          required: true,
          inputType: "text",
        },
        {
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "metrics",
          type: TWorkflowQuestionType.OpenText,
          headline: "What metrics would you like to take into account?",
          subheader: "Customer engagement metrics",
          required: true,
          inputType: "text",
        },
        {
      ...
      questions: [
        {
          ...
          type: TWorkflowQuestionType.OpenText,
          headline: "Paste here the customer feedback",
          subheader: "",
          required: true,
          inputType: "text",
        },
        ...
        },
        {
          id: "date-range",
          type: TWorkflowQuestionType.OpenText,
          headline: "What's the date range?",
          subheader: "",
          required: true,
          inputType: "text",
        },
