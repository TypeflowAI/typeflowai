...
export const supportTemplates: TTemplate[] = [
      ...
      questions: [
        {
          ...
          headline: "What is the product name?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "product",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is the product about?",
      ...
      questions: [
        {
          id: "services",
          type: TWorkflowQuestionType.OpenText,
          headline: "What type of services would you like to improve?",
          subheader: "Please be as specific as possible.",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "instructions",
          type: TWorkflowQuestionType.OpenText,
          headline: "Write some instructions for using the product/service",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "issues",
          type: TWorkflowQuestionType.OpenText,
          headline: "What are common issues/problems that customers face of?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "product-service",
          type: TWorkflowQuestionType.OpenText,
          headline: "What product or service do you want to know more about?",
          subheader: "Please be as specific as possible.",
          required: true,
          inputType: "text",
        },
        {
          id: "features",
          type: TWorkflowQuestionType.OpenText,
          headline: "What features are you looking for?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "quality",
          type: TWorkflowQuestionType.OpenText,
          headline: "What quality are you looking for?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "budget",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is your budget range?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "chat-logs",
          type: TWorkflowQuestionType.OpenText,
          headline: "Paste here the chat logs that you would like to moderate",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "e-mail",
          type: TWorkflowQuestionType.OpenText,
          headline: "Paste here the original E-mail",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "reason-return",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is the reason for return?",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "position",
          type: TWorkflowQuestionType.OpenText,
          headline: "What position have you hired?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "company-goals",
          type: TWorkflowQuestionType.OpenText,
          headline: "What are the company goals?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "company-culture",
          type: TWorkflowQuestionType.OpenText,
          headline: "What are the company culture?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "issue",
          type: TWorkflowQuestionType.OpenText,
          headline: "What issue/problem is facing the customer?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "complaint",
          type: TWorkflowQuestionType.OpenText,
          headline: "What complaint are you trying to handle?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "circumstance",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is the current circumstance?",
          subheader: "",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "topic",
          type: TWorkflowQuestionType.OpenText,
          headline: "Tell us a specific topic to generate a detailed support about",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "action",
          type: TWorkflowQuestionType.OpenText,
          headline: "What action would you like to answer",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "product",
          type: TWorkflowQuestionType.OpenText,
          headline: "Which product are your customers trying to return?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "reason",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is the reason of the payment issue?",
          subheader: "E.g. It wasn't the correct amount/was declined]",
          required: true,
          inputType: "text",
        },
      ],
      ...
      questions: [
        {
          id: "customer-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is the customer's name?",
          subheader: "",
          required: true,
          inputType: "text",
        },
        {
          id: "product-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is the product's name?",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "type-document",
          type: TWorkflowQuestionType.OpenText,
          headline: "What type of legal document would you like to create?",
          subheader: "Please be as specific as possible.",
          required: true,
          inputType: "text",
        },
        {
          id: "terms-conditions",
          type: TWorkflowQuestionType.OpenText,
          headline: "Describe the terms and conditions",
          subheader: "Please be as specific as possible.",
          required: true,
          inputType: "text",
        },
        {
          ...
          type: TWorkflowQuestionType.OpenText,
          headline: "What is your business/organization about?",
          subheader: "Please be as specific as possible.",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "brand-name",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is the brand name?",
          subheader: "Please be as specific as possible.",
          required: true,
          inputType: "text",
        },
        {
          id: "time-frame",
          type: TWorkflowQuestionType.OpenText,
          headline: "What time frame are you interest in?",
          subheader: "E.g. Day, Month, Quarter...",
          required: true,
          inputType: "text",
        },
      ],
      ...
      questions: [
        {
          id: "comment",
          type: TWorkflowQuestionType.OpenText,
          headline: "Paste here the comment to moderate",
          subheader: "",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "product-service",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is your product/service about?",
          subheader: "Please be as specific as possible.",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: "task",
          type: TWorkflowQuestionType.OpenText,
          headline: "What specific task would you like to add?",
          subheader: "E.g. adding a new product feature or updating pricing information",
          required: true,
          inputType: "text",
        },
      ],
      ...
      questions: [
        {
          id: "inquiries",
          type: TWorkflowQuestionType.OpenText,
          headline: "What inquiries would you like to address?",
          subheader: "Please be as specific as possible.",
          required: true,
          inputType: "text",
        },
        {
          id: "topic",
          type: TWorkflowQuestionType.OpenText,
          headline: "What topic would you like to resolve?",
          subheader: "Please be as specific as possible.",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          ...
          type: TWorkflowQuestionType.OpenText,
          headline: "Describe briefly the onboarding process?",
          subheader: "",
          required: true,
          inputType: "text",
        },
  ...
  },
  {
    ...
    category: "Support",
    subcategory: "Chatbot & Virtual Assistants",
    description: "Streamline the process of designing chatbots for user feedback and surveys.",
    objectives: ["improve_customer_and_employee_experience", "other"],
    isPremium: false,
    preset: {
      ...
      questions: [
        {
          id: "feature",
          type: TWorkflowQuestionType.OpenText,
          headline: "What feature would you like to create?",
          subheader: "Please be as specific as possible.",
          required: true,
          inputType: "text",
        },
        {
          id: "product-goal",
          type: TWorkflowQuestionType.OpenText,
          headline: "What is the goal of your product/service?",
          subheader: "Please be as specific as possible.",
          required: true,
          inputType: "text",
        },
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          ...
          type: TWorkflowQuestionType.OpenText,
          headline: "What type of warranty inquiries do you need to solve?",
          subheader: "Please be as specific as possible.",
          required: true,
          inputType: "text",
        },
      ...
      questions: [
        {
          id: "user-needs",
          type: TWorkflowQuestionType.OpenText,
          headline: "Paste here the user needs",
          subheader: "",
          required: true,
          inputType: "text",
        },
