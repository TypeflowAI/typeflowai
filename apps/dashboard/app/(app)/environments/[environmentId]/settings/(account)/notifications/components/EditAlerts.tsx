        ...
        <>
          <div className="mb-5 grid grid-cols-6 items-center space-x-3">
            ...
            <div className="col-span-3 flex items-center justify-end pr-2">
              <p className="pr-4 text-sm text-slate-600">Auto-subscribe to new workflows</p>
              <NotificationSwitch
                workflowOrProductOrTeamId={membership.team.id}
          ...
          <div className="mb-6 rounded-lg border border-slate-200">
            <div className="grid h-12 grid-cols-3 content-center rounded-t-lg bg-slate-100 px-4 text-left text-sm font-semibold text-slate-900">
              <div className="col-span-2 flex items-center">Workflow</div>
            ...
            {membership.team.products.some((product) =>
              product.environments.some((environment) => environment.workflows.length > 0)
            ) ? (
                  ...
                  <div key={product.id}>
                    {product.environments.map((environment) => (
                      <div key={environment.id}>
                        {environment.workflows.map((workflow) => (
                          <div
                            ...
                            <div className="col-span-1 text-center">
                              <NotificationSwitch
                                workflowOrProductOrTeamId={workflow.id}
                                notificationSettings={user.notificationSettings!}
