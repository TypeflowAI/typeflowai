export const users = {
  ...
  onboarding: [
    {
      ...
      email: "onboarding1@typeflowai.com",
      password: "iHalLonErFGK$X901R0",
    },
    {
      name: "Onboarding User 2",
      email: "onboarding2@typeflowai.com",
  ...
  workflow: [
    {
      ...
      email: "workflow1@typeflowai.com",
      password: "Y1I*EpURUSb32j5XijP",
    },
    {
      name: "Workflow User 2",
      email: "workflow2@typeflowai.com",
      password: "G73*Gjif22F4JKM1pA",
    },
    {
      name: "Workflow User 3",
      email: "workflow3@typeflowai.com",
      password: "Gj2DGji27D&M8u53V",
    },
    {
      name: "Workflow User 4",
      email: "workflow4@typeflowai.com",
  ...
  action: [
    {
      name: "Action User 1",
      email: "action1@typeflowai.com",
      password: "XpP%X9UU3efj8vJa",
    },
    {
      name: "Action User 2",
      email: "action2@typeflowai.com",
      password: "XpP%X9UU3efj8vJa",
    },
    {
      name: "Action User 3",
      email: "action3@typeflowai.com",
      password: "XpP%X9UU3efj8vJa",
    },
    {
      name: "Action User 4",
      email: "action4@typeflowai.com",
      password: "XpP%X9UU3efj8vJa",
    },
    {
      name: "Action User 5",
      email: "action5@typeflowai.com",
      password: "XpP%X9UU3efj8vJa",
    },
  ],
  team: [
    {
      name: "Team User 1",
      email: "team1@typeflowai.com",
      password: "Test#1234",
    },
    {
      name: "Team User 2",
      email: "team2@typeflowai.com",
      password: "Test#1234",
    },
  ],
};
...
export const workflows = {
  createAndSubmit: {
    welcomeCard: {
      headline: "Welcome to My Testing Workflow Welcome Card!",
...
export type CreateWorkflowParams = typeof workflows.createAndSubmit;
