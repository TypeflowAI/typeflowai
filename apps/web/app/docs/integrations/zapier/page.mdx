...
In order to set up Zapier you’ll need a test response. This allows you to select the individual values of each response in your Zap. If you have TypeflowAI running locally and you want to set up an in-app workflow, you can use our [Demo App](/docs/contributing/demo) to trigger a workflow and submit a response.
...
{/* <Image src={AddNewZap} alt="Add New Zap" quality="100" className="max-w-full rounded-lg sm:max-w-3xl" /> */}

Then, choose the event you want to trigger the Zap on:

{/* <Image src={ChooseEvent} alt="Choose Event" quality="100" className="max-w-full rounded-lg sm:max-w-3xl" /> */}
...
In the action itself we can determine the data and layout of the message. Here, we only choose the submission data. You can also refer to the meta data of the submission and the [attributes](/docs/attributes/why) of the person who submitted the workflow.

{/* <Image src={SlackMsg} alt="Slack Message" quality="100" className="max-w-full rounded-lg sm:max-w-3xl" /> */}
