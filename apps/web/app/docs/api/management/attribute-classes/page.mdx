...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X POST https://dashboard.typeflowai.com/api/v1/management/attribute-classes/ \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://dashboard.typeflowai.com/api/v1/management/attribute-classes/<attribute-class-id> \
     --header 'x-api-key: <your-api-key>'
    ```
