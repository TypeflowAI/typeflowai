...
export const navigation: Array<NavGroup> = [
  {
    title: "Introduction",
    links: [{ title: "What is TypeflowAI?", href: "/docs/introduction/what-is-typeflowai" }],
  },
  {
  ...
  {
    title: "Self-hosting",
    links: [{ title: "Self Hosting Guide", href: "/docs/self-hosting/self-hosting-guide" }],
  },
  {
    title: "Contributing",
    links: [
      ...
      { title: "How we code at TypeflowAI", href: "/docs/contributing/how-we-code" },
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Workflows", href: "/docs/api/management/workflows" },
