...
const GitHubButton = ({ inverted }: GitHubButtonProps) => {
    ...
    <>
      {inverted ? (
        <Button
          ...
          target="_blank"
          size="lg"
          className="hover:text-brand px-3 text-gray-900"
          onClick={() => {
            plausible("Github_CTA");
            router.push("https://github.com/TypeflowAI/typeflowai");
          }}>
        ...
        <Button
          ...
          target="_blank"
          size="lg"
          className="px-3 text-violet-950 hover:text-gray-900"
          onClick={() => {
            plausible("Github_CTA");
            router.push("https://github.com/TypeflowAI/typeflowai");
          }}>
