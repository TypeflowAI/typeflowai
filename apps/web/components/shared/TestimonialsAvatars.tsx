...
const TestimonialsAvatars = ({ priority }: { priority?: boolean }) => {
  return (
    <div className="relative z-[2] flex items-center justify-center gap-3 lg:flex-row lg:justify-start">
      ...
      <div className="my-auto flex flex-col items-center justify-center gap-1 md:items-start">
