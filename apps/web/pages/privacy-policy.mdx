...
export const meta = {
  ...
  description: "TypeflowAI Privacy Policy",
};
...
This Privacy Policy explains how and why our organization collects personal data and how it is used. If you have any questions after reading this Privacy Policy, feel free to contact us at **support@typeflowai.com**

### Important Notice

This Privacy Policy only applies to the TypeflowAI Cloud under [https://dashboard.typeflowai.com](https://dashboard.typeflowai.com) (”Cloud”) and our Landing Page under typeflowai.com. (”Landing Page”) If you are self-hosting our open source tool on your own servers, this Privacy Policy does not apply.

### Definitions

To avoid confusion, let’s define who we collect data from:

- Researcher: the person who uses the Cloud to create and distribute TypeflowAI forms and workflows or manage submissions from other forms
- Website visitors: People who visit our marketing landing page

### We are data processor, you are data controller

With our Cloud we are a provider of this Service. We are not the owner of the collected personal data from workflow respondents. The Researcher (the person who sends out a form i.e. you) is responsible for the data they collect and thus data controller of respondent data.
...
- **Billing information:**
  If you pay for TypeflowAI, we will ask for your billing details including name, address and financial information depending on your payment method (stored by our payment service provider Stripe)
- **Workflow data:**
  We store your workflow data (questions and responses) for you and provide tools for you to analyse and use this data.
- **Error logs:**
  We collect error logs to help us diagnose and fix issues with our service.

## **How we use your data**

TypeflowAI does not sell personal data to third parties. Generally, we only collect your data with your consent in order to:
...
We only share your information with our Service providers who help us operate our business, in which case those third parties are also required to comply with the GDPR framework. We worked hard to reduce the number of subprocessors to a minimum and keep your information. This is a list of the subprocessors we are working with:
...
| PostHog      | Anon. IP, Browser & Device Information | Product Analytics | 🇺🇸              | DPA signed  | [GDPR Info](https://posthog.com/docs/privacy/gdpr-compliance)                     |
...
If you are a TypeflowAI Researcher we do not delete the data in your account. You can delete data in your TypeflowAI account. You are responsible for the time period for which you store the data.

If you are a Respondent, you will need to ask the Researcher how long your responses will be stored in TypeflowAI.
...
If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at support@typeflowai.com.
...
- Users are able to change their personal information by emailing us at support@typeflowai.com
...
To exercise your California data protection rights described above, please send your request(s) by email to support@typeflowai.com.
...
If Researchers register to TypeflowAI, we may send them emails about company news, updates, related product or service information, etc. Researchers can always opt out of the email communications.

## **Cookies**

Cookies are small text files that are placed on your computer or mobile device by websites you visit. They are widely used in order to make a website work, or work more efficiently, as well as to provide information to the owners of the site. TypeflowAI uses cookies to improve your experience on our website and with our product.

TypeflowAI uses cookies to improve your user experience, including:

- Keeping you signed in
- Understanding how you use our product

### What types of cookies does TypeflowAI use?
...
TypeflowAI is based in the United States and all form and user data is stored in United States.

## **Users Acceptance Of These Terms**

By using TypeflowAI, Researchers signify their acceptance of this policy. If Researchers do not agree to this policy, they should not use TypeflowAI. Researchers continued use of TypeflowAI following the posting of changes to this policy will be deemed their acceptance of those changes.
...
support@typeflowai.com

SaasKitchen LLC<br/>
8 The Green, STE 4000, Dover<br/>
19901 Delaware<br/>
EEUU
