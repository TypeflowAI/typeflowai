...
export function Libraries() {
  return (
    <div className="my-16 xl:max-w-none">
      <div className="not-prose mt-4 grid grid-cols-1 gap-x-6 gap-y-10 border-slate-900/5 sm:grid-cols-2 xl:max-w-none xl:grid-cols-3">
        {libraries.map((library) => (
          <a
            ...
            <div className="flex-auto">
              <h3 className="text-sm font-semibold text-slate-900">{library.name}</h3>
              <p className="mt-1 text-sm text-slate-600">{library.description}</p>
              <p className="mt-4">
