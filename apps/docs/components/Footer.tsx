...
function SmallPrint() {
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-slate-900/5 pt-8 sm:flex-row">
      <p className="text-xs text-slate-600">SaasKitchen LLC &copy; {currentYear}. All rights reserved.</p>
      <div className="flex gap-4">
        <SocialLink href="https://github.com/TypeflowAI/typeflowai" icon={FaGithub}>
          Follow us on GitHub
        </SocialLink>
        {/* <SocialLink href="https://typeflowai.com/discord" icon={FaDiscord}>
